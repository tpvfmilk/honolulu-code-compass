...
export function calculateExteriorWallRating(formData: FormData | FireSafetyCalculationsProps) {
  const fireSafety = getProperty(formData, 'fireSafety');
  const separationDistance = parseFloat(fireSafety.separationDistance);
